                ...
                <div style="" class="modal-content" id="main_popup">
                    <div class="modal-body  ">
                        ...
                        <div class="heading_msg">
                            <h3>Please help us serve you better by telling us about our services you experience so far. We appreciate your choice and want to make sure we meet your expectations.</h3>
                        </div>
                ...
                <div id="page2" style="display:none;" class="modal-content" style="box-shadow:none;">
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="row">
                            ...
                            <a href="#" class="previous"id="arr1" style="margin-right:0px;">&laquo; Prev</a>&nbsp;&nbsp;
                            <a href="#" class="next"id="arr2">Next &raquo;</a>
                            </div>
                        </div>
                ...
                <div id="page3" style="display:none;" class="modal-content">
                    ...
                    <div class="modal-footer col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 hidden-xs">
                            <a href="#" class="previous"id="arr3" style="margin-right:0px;">&laquo; Prev</a>&nbsp;&nbsp;
                            <a href="#" class="next"id="arr4">Next &raquo;</a>
                            </div>
                        </div>
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="thank_you_body">
                            <div class="heading_msg2">
                                <h3>
                                    <span>Thank you!</span><br> Your feedback was sent perfectly. We will work on it to improve our servives if necessary.
                                </h3>

                            </div>
                            <div class="row text-center give_feedback">

                                <button type="submit" class="btn btn-default " data-dismiss="modal" id="finalsubmit">Close</button>
